...
public class MOrder extends X_C_Order implements DocAction
{
	...
	//	shipment.setDateAcct(getDateAcct());
		...
		//mfrojas 20210706
		//Se agrega ofbforward. Si es Y, no se debe completar este documento (Para HFBC)
        if(!OFBForward.HFBCPosOrderComplete())
	...
	private MInvoice createInvoice (MDocType dt, MInOut shipment, Timestamp invoiceDate)
	{
		...
		//mfrojas 20210706
		//Si se cumple el ofbforward de hfbc, la factura se creará desde la orden.
