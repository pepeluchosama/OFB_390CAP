...
implements IDocumentLine , DocumentReversalLineEnable
{
	...
	protected boolean beforeDelete ()
	{
		...
		//mfrojas 20220728. Se puede eliminar en estados intermedios, pero no cuando el documento esta procesado. 
		//if (getParent().getDocStatus().equals(MInOut.DOCSTATUS_Drafted))
		if (getParent().getDocStatus().compareTo("CO") != 0 &&
				getParent().getDocStatus().compareTo("CL") != 0 &&
				getParent().getDocStatus().compareTo("VO") != 0 &&
				getParent().getDocStatus().compareTo("RE") != 0 )
