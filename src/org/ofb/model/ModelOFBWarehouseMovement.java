 ...
 *  @author mfrojas
 */
public class ModelOFBWarehouseMovement implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModelOFBWarehouseMovement ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModelOFBWarehouseMovement.class);
	/** Client			*/
